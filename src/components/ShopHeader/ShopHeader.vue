<template>
  <div class="shop-header">
    ...
    <div class="shop-header-discounts" @click="isShowActivityList=true" v-if="info.supports">
    ...
    <div class="shop-brief-modal" v-show="isShowInfo">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer" @click="isShowInfo=false">
          <span class="iconfont iconchenghao"></span>
        </div>
      </div>
      <div class="brief-modal-cover"></div>
    </div>

    <div class="activity-sheet" v-show="isShowActivityList">
      <div class="activity-sheet-content">
        <h2 class="activity-sheet-title">
          优惠活动</h2>
        <ul class="list">
          <li  class="activity-item" v-for="(item, index) in info.supports" :key="index" :class="classType[item.type]" >
            <span class="content-tag">
        ...
        <div class="activity-sheet-close" @click="isShowActivityList=false">
          <span class="iconfont iconchenghao"></span>
        </div>
      </div>
